...
class MCSClient extends MCSBaseClient {
  ...
  /**
   * 
   * @param {String} rooomId 
   * @param {String} mediaId
   */
  getConferenceFloor (roomId, mediaId) {
    if (!roomId || typeof(roomId) !== 'string') {
      throw new Error('Invelid userId');
    }
    if (!mediaId || typeof(mediaId) !== 'string') {
      throw new Error('Invelid userId');
    }

    const message = new GetConferenceFloorMessage(roomId, mediaId)
    if (message) {
      return this.deferTransaction(message)
    }
  }
   ...
   * @param {String} mediaId
   */
  getContentFloor (roomId, mediaId) {
    if (!roomId || typeof(roomId) !== 'string') {
      throw new Error('Invelid userId');
    }
    if (!mediaId || typeof(mediaId) !== 'string') {
    ...
    const message = new GetContentFloorMessage(roomId, mediaId)
    if (message) {
      return this.deferTransaction(message)
    }
  }
  ...
  dtmf (mediaId, digit) {
    ...
    if (!mediaId || typeof digit !== 'number') {
